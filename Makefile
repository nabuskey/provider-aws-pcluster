# ====================================================================================
# Setup Project
PROJECT_NAME := provider-awspcluster
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider AwsPcluster CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider AwsPcluster controllers
...
# This target prepares repo for your provider by replacing all "awspcluster"
